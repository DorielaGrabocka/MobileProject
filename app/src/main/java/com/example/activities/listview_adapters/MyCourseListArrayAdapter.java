...
public class MyCourseListArrayAdapter extends ArrayAdapter<Course> {
    private Context context;
    public MyCourseListArrayAdapter(@NonNull Context context, int resource, @NonNull List objects) {
